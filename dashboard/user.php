...
<?php include_once("../Common/drower.php"); ?>
			...
			<div class="min-height-200px">
				...
				<?php 
					...
					while ($row = mysqli_fetch_array($result)) {
							...
							echo 				'<a class="dropdown-item" href="#" onclick="viewuser(\'' . $row['empNo'] . '\', \'' . $row['uname'] . '\', \'' . $row['phone'] . '\')">
    			...
    			<div class="modal-dialog" role="document">
        			<div class="modal-content">
                		...
                		<!-- Display service details here -->
                			...
                			<p><strong>Name:</strong> <span id="viewuname"></span></p>
	...
	<script>
    			function viewuser(empNo, uname, phone) {
        		// Set the data in the modal
        		document.getElementById("viewId").textContent = empNo;
