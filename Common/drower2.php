        ...
        <div class="user-info-dropdown">
            <div class="dropdown">
                <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                    ...
                    <span class="user-name">Sub Office</span>
                </a>
            ...
            <ul id="accordion-menu">
                ...
                <li>
                    <a href="clients.php" class="dropdown-toggle no-arrow">
                        <span class="micon fa fa-cogs"></span><span class="mtext">Customer List</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="Delivary.php" class="dropdown-toggle no-arrow">
                        <span class="micon dw dw-house"></span><span class="mtext">Delivary List</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="workorder.php" class="dropdown-toggle no-arrow">
                        <span class="micon dw dw-money"></span><span class="mtext">Work Order List</span>
                    </a>
                </li>
