        ...
        <div>
        	...
        	<table>
        		<tr>
            		<td>
                 		Delivery ID:<br/>
                		<input type="text" name="DeliId" placeholder="Delivary ID" required>
            		</td>
        		</tr>
				...
				<tr>
					<td colspan="2">
						Name:<br/>
						<textarea name="DeliName" placeholder="Delivary Name"  required></textarea>
					</td>
				</tr>
				<tr>
					<td >
                ...
                <tr>
					<td>
						Address:<br/>
						<input type="text" name="DeliAddress"  class="area" rows="8" cols="50" required>
					</td>
				</tr> 
				<tr>
					<td colspan="2">
